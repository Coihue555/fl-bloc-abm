                ...
                if (snapshot.hasData) {
                  return ListView.builder(
                      ...
                      itemBuilder: (_, i) => Dismissible(
                            ...
                            child: ListTile(
                                leading: Icon(Icons.sports_baseball_outlined, color: Theme.of(context).primaryColor),
                                title: Text(snapshot.data![i].nombre.toString()),
                                subtitle: Text(snapshot.data![i].descripcion.toString(),),
                                trailing: Text('Edades:'+ snapshot.data![i].edadMin.toString() +' - '+snapshot.data![i].edadMax.toString()),
